  ...
  return (
    <aside className="w-64 bg-white border-r shadow-sm p-6 hidden lg:block">
      ...
      <ul className="space-y-4 text-gray-700 text-base">
        ...
        <li className="hover:text-blue-600 cursor-pointer flex items-center">
          <Link to="/hr-tests" className="flex items-center">
            🧪 <span className="ml-2">Test Manager</span>
          </Link>
        </li>
        <li className="hover:text-blue-600 cursor-pointer flex items-center">
          <Link to="/interviews" className="flex items-center">
            📅 <span className="ml-2">Interview Scheduler</span>
          </Link>
        </li>
        <li className="hover:text-blue-600 cursor-pointer flex items-center">
          <Link to="/interview-candidates" className="flex items-center">
            ✅ <span className="ml-2">Interview Candidates</span>
          </Link>
        </li>
        <li className="hover:text-blue-600 cursor-pointer flex items-center">
