...
const Settings = () => {
  ...
  const loadAgents = async () => {
    try {
      const res = await fetch('http://localhost:5003/api/settings/agents');
  ...
  const loadAgentPrompts = async (agentName) => {
    try {
      const res = await fetch(`http://localhost:5003/api/settings/agents/${encodeURIComponent(agentName)}/prompts`);
      const data = await res.json();
      if (data.success) {
  ...
  const loadFeedbackHistory = async () => {
    try {
      const res = await fetch('http://localhost:5003/api/settings/feedback');
      const data = await res.json();
      if (data.success) {
  ...
  const loadMetrics = async () => {
    try {
      const res = await fetch('http://localhost:5003/api/settings/monitoring/metrics');
      const data = await res.json();
      if (data.success) {
  ...
  const handleApplyFeedback = async (feedbackId) => {
    ...
    try {
      const res = await fetch(`http://localhost:5003/api/settings/feedback/${feedbackId}/apply`, {
        method: 'POST'
      });
